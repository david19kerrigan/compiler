...
SRC_DIR = ./src
BUILD_DIR = ./build
TEST_FILES = math_1.c math_2.c math_3.c vars_1.c vars_2.c vars_3.c vars_4.c bool_1.c bool_2.c bool_3.c cond_1.c
ANS = 19 15 66 9 21 42 1643628 1 0 1 12
...
test:
	...
	for test_file in $(TEST_FILES); do \
		...
		cat $(BUILD_DIR)/main.asm $(BUILD_DIR)/main_suffix.asm > $(BUILD_DIR)/main_combined.asm ; \
		cat $(BUILD_DIR)/main_combined.asm ; \
		$(AC) $(AFLAGS) $(BUILD_DIR)/main_combined.asm -o $(BUILD_DIR)/main.out ; \
